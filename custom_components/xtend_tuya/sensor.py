...
CONSUMPTION_SENSORS: tuple[XTSensorEntityDescription, ...] = (
    ...
    XTSensorEntityDescription(
        ...
        virtual_state=VirtualStates.STATE_COPY_TO_MULTIPLE_STATE_NAME,
        vs_copy_to_state=[
            XTDPCode.FORWARD_ENERGY_TOTAL2,
            XTDPCode.FORWARD_ENERGY_TOTAL_TODAY,
            XTDPCode.FORWARD_ENERGY_TOTAL_THIS_MONTH,
            XTDPCode.FORWARD_ENERGY_TOTAL_THIS_YEAR,
        ],
        vs_copy_delta_to_state=[
            XTDPCode.FORWARD_ENERGY_TOTAL2_TODAY,
            XTDPCode.FORWARD_ENERGY_TOTAL2_THIS_MONTH,
            XTDPCode.FORWARD_ENERGY_TOTAL2_THIS_YEAR,
        ],
    ...
    XTSensorEntityDescription(
        key=XTDPCode.FORWARD_ENERGY_TOTAL2,
        virtual_state=VirtualStates.STATE_COPY_TO_MULTIPLE_STATE_NAME,
        vs_copy_delta_to_state=[
            XTDPCode.FORWARD_ENERGY_TOTAL2_TODAY,
            XTDPCode.FORWARD_ENERGY_TOTAL2_THIS_MONTH,
    ...
    XTSensorEntityDescription(
        ...
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total_today",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=True,
    ...
    XTSensorEntityDescription(
        ...
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total_this_month",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=True,
    ...
    XTSensorEntityDescription(
        ...
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total_this_year",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=True,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.FORWARD_ENERGY_TOTAL2_TODAY,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total2_today",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.FORWARD_ENERGY_TOTAL2_THIS_MONTH,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total2_this_month",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    XTSensorEntityDescription(
        key=XTDPCode.FORWARD_ENERGY_TOTAL2_THIS_YEAR,
        virtual_state=VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        translation_key="forward_energy_total2_this_year",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        entity_registry_enabled_default=False,
    ...
    XTSensorEntityDescription(
        ...
        | VirtualStates.STATE_SUMMED_IN_REPORTING_PAYLOAD,
        vs_copy_to_state=[
            XTDPCode.POWER_CONSUMPTION2,
            XTDPCode.POWER_CONSUMPTION_TODAY,
            XTDPCode.POWER_CONSUMPTION_THIS_MONTH,
            XTDPCode.POWER_CONSUMPTION_THIS_YEAR,
        ],
        translation_key="add_ele",
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.TOTAL_INCREASING,
