 ...
 */function ht(t){return lt({...t,state:!0,attribute:!1})}var pt;!function(t){t[t.Duration=0]="Duration",t[t.Volume=1]="Volume"}(pt||(pt={}));const ut=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];class mt extends ot{constructor(){super(...arguments),this._timers=new Map,this._editing=null,this._isNew=!1,this._resyncing=!1,this._resyncStatus=null}setConfig(t){if(!t.entity)throw new Error("Please define an entity (timer registry sensor)");if(!t.device_id)throw new Error("Please define a device_id");this._config=t}getCardSize(){return 4}updated(t){t.has("hass")&&this.hass&&this._updateTimersFromState()}_updateTimersFromState(){const t=this.hass.states[this._config.entity];if(!t)return;const e=t.attributes?.slots;if(!e)return;const i=new Map;for(let t=0;t<7;t++){const s=e[String(t)];s&&i.set(t,{slot:t,mode:"volume"===s.mode?pt.Volume:pt.Duration,value:s.value,hour:s.hour,minute:s.minute,daysMask:s.days_mask,enabled:s.enabled})}this._timers=i}_newTimer(){for(let t=0;t<7;t++)if(!this._timers.has(t))return{slot:t,mode:pt.Duration,value:900,hour:6,minute:0,daysMask:127,enabled:!0};return{slot:0,mode:pt.Duration,value:900,hour:6,minute:0,daysMask:127,enabled:!0}}async _sendSetTimer(t){await this.hass.callService("xtend_tuya","fdm5kw_set_timer",{device_id:this._config.device_id,slot:t.slot,hour:t.hour,minute:t.minute,mode:t.mode===pt.Volume?"volume":"duration",value:t.value,days:t.daysMask,enabled:t.enabled})}async _sendDeleteTimer(t){await this.hass.callService("xtend_tuya","fdm5kw_delete_timer",{device_id:this._config.device_id,slot:t})}async _saveTimer(){this._editing&&(await this._sendSetTimer(this._editing),this._timers=new Map(this._timers),this._timers.set(this._editing.slot,{...this._editing}),this._editing=null,this._isNew=!1)}async _deleteTimer(t){await this._sendDeleteTimer(t),this._timers=new Map(this._timers),this._timers.delete(t)}async _resync(){if(!this._resyncing){this._resyncing=!0,this._resyncStatus=null;try{const t=await this.hass.callService("xtend_tuya","fdm5kw_resync_timers",{device_id:this._config.device_id},void 0,void 0,!0),e=t?.response??{};if(!1===e.success)this._resyncStatus=`Resync failed: ${e.error??"unknown"}`;else{const t=e.orphans_cleared??0,i=[];0===t?i.push("All in sync"):i.push(`Cleared ${t} zombie${1===t?"":"s"}`),e.orphans_deferred&&i.push(`${e.orphans_deferred} deferred (quota)`),this._resyncStatus=i.join(" · ")}}catch(t){this._resyncStatus=`Resync failed: ${t}`}finally{this._resyncing=!1,window.setTimeout(()=>{this._resyncStatus=null},5e3)}}}_startEdit(t){this._editing={...t},this._isNew=!1}_startNew(){this._editing=this._newTimer(),this._isNew=!0}_cancelEdit(){this._editing=null,this._isNew=!1}render(){if(!this._config||!this.hass)return q;const t=this.hass.states[this._config.entity]?.attributes,e=t?.valve_name,i=this._config.name??e??t?.friendly_name??"Irrigation Timer",s=t?.valve_home,r=t?.valve_room,n=[s,r].filter(t=>t&&String(t).trim()).join(" · ");return V`
    ...
    `}_renderTimerRow(t){const e=`${t.hour.toString().padStart(2,"0")}:${t.minute.toString().padStart(2,"0")}`,i=t.mode===pt.Duration?t.value<60?`${t.value}s`:t.value%60==0?t.value/60+"min":`${Math.floor(t.value/60)}min ${t.value%60}s`:`${t.value}L`,s=ut.filter((e,i)=>t.daysMask&1<<i).join(", ");return V`
